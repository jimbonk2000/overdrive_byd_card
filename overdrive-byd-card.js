class OverdriveBYDCard extends HTMLElement {
  ...
  entity(key) {
    ...
    const defaults = {
      ...
      tyre_p_fr: `sensor.${p}_tyre_p_fr`,
      tyre_p_rl: `sensor.${p}_tyre_p_rl`,
      tyre_p_rr: `sensor.${p}_tyre_p_rr`,
      tyre_t_fl: `sensor.${p}_tyre_t_fl`,
      tyre_t_fr: `sensor.${p}_tyre_t_fr`,
      tyre_t_rl: `sensor.${p}_tyre_t_rl`,
      tyre_t_rr: `sensor.${p}_tyre_t_rr`,
