class OverdriveBYDCard extends HTMLElement {
  ...
  entity(key) {
    ...
    const defaults = {
      ...
      tyre_t_fl: `sensor.${p}_tyre_temperature_front_left`,
      tyre_t_fr: `sensor.${p}_tyre_temperature_front_right`,
      tyre_t_rl: `sensor.${p}_tyre_temperature_rear_left`,
      tyre_t_rr: `sensor.${p}_tyre_temperature_rear_right`,
